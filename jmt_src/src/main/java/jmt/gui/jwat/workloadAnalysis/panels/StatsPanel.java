...
public class StatsPanel extends WizardPanel implements CommonConstants, JWATConstants {
	...
	public final static String SAMPLING_TRIMMING_PANEL_DESC = HTML_START
			...
			+ HTML_FONT_TIT_END
			+ HTML_FONT_NORM
			+ "At this time you can apply any number of sampling operations and transformations to data with the constraint that you cannot apply any transformation after a sampling;"
					...
					if (((String) transfs.getSelectedItem()).equals("Logarithmic")) {
						try {
							...
							JOptionPane.showMessageDialog(null,
									"it is impossible to apply logaritmic transformation due to the presence of 0 or negative values", "Erroe",
	...
	private JPanel filterD;

	private JPanel filterN;
	private JTextField subs;
	private JSpinner minN;

	private JSpinner maxN;
	//private CalendarComboBox fromD,toD;
	private JFormattedTextField fromD;

	private JFormattedTextField toD;
