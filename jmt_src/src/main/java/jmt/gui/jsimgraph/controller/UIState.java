...
/**
 * This interface defines the states of the user interface in particular of the
 * mouse listener of the GraphMouseListener. it is used to abstract the behaviour
 * of the mouse listener from the state of the UI. In this way it is not necessary
 * to use a case for every situation, it is needed to change the state of the
 * mouse listener to change it is behaviour.
 *
