...
/**
 * This class represents a single observation retrieved from a log file. Every element is a double number
 * that represents either the true value or the converted value representing a string, date or other types.
 * 
