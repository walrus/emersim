package jmt.jmva.analytical.solvers.QueuingNet.amva;
 ...
 *
 */
public class Linearizer extends AMVA {
	// boolean to decide which version of Linearizer to use
	private boolean useDeSouzaMuntz;
	
	public Linearizer(int classes, int stations, int[] classPopulation, boolean useDeSouzaMuntz) {
