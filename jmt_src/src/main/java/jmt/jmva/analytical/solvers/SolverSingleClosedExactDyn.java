 ...
 */
public class SolverSingleClosedExactDyn extends jmt.jmva.analytical.solvers.SolverSingleClosedExact {
	...
	/** Calculates the indices of interest for the system.<br>
