...
public final class StationsPanel extends WizardPanel implements ExactConstants, ForceUpdatablePanel {
	...
	private class StationTable extends ExactTable {
		...
		StationTable() {
			...
			JComboBox<String> stationTypeBox = new JComboBox<String>(STATION_TYPENAMES);
			...
			JComboBox<String> LD_enabled_StationTypeBox = new JComboBox<String>(STATION_TYPENAMES_LD_ENABLED);
		...
		public void setValueAt(Object value, int rowIndex, int columnIndex) {
			switch (columnIndex) {
				...
				case 1: //type
					...
					boolean isLd = isLD();
					ew.updateAlgoPanel(null, null, null, isLd);
					if (isLd) {
