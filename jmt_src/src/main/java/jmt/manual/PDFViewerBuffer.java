...
TreeSelectionListener {
	...
	//size of buffer
	private static final int BUFFER_SIZE = 3;// MUST BE ODD
	//size of page display
	private static final int PAGE_DIMENSION_RATIO = 65;
	...
	private static final int SCROLLBAR_ACCURACY = 1;
