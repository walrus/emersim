...
public class BDMapImpl implements BDMap {
	...
	private Object[] xKeys = new Object[0];

	private Object[] yKeys = new Object[0];
	...
	/**tells whether a key mapping is present in this BDMap along a specified coord
	...
	/**Tells whether this BDMap is empty.*/
